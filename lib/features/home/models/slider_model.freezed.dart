...
class _$SliderModelImpl implements _SliderModel {
  const _$SliderModelImpl({required this.name, required this.imageUrl});
  ...
  @override
  String toString() {
    return 'SliderModel(name: $name, imageUrl: $imageUrl)';
  }
...
abstract class _SliderModel implements SliderModel {
  const factory _SliderModel(
      ...
      required final String imageUrl}) = _$SliderModelImpl;
