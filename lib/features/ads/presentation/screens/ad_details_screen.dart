  ...
  Ad _getDummyAd() {
    return Ad(
      ...
      adDetails: AdDetails(
        ...
        likes: 5,
        views: 15482,
        description: 'Hiring male and female drivers with their own cars. Quick registration. Reliable delivery services at Al-Hadaf Delivery Services Company. Available Jobs: Drivers with their own cars 200 vacancies. Application fee: 14 riyals.',
      ),
      user: AdUser(
        id: '1',
