...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(data: $data, success: $success, message: $message, exception: $exception, stackTrace: $stackTrace)';
  }
...
abstract class _ApiResponse<T> implements ApiResponse<T> {
  const factory _ApiResponse(
      ...
      required final String stackTrace}) = _$ApiResponseImpl<T>;
